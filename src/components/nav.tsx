...
const Navbar: React.FC = () => {
    return (
        <div className="absolute  w-full flex justify-center bg-[#F6F8FA]  border-b-2 h-fit top-0">
            <div className="w-[860px] h-16 flex justify-between m-4 items-center px-6 rounded-full ">
